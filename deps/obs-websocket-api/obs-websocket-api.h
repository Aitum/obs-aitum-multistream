/*
 * Vendored from obs-websocket so this plugin still builds where OBS's own
 * copy of the header is not installed (see CMakeLists.txt, which prefers the
 * installed obs-websocket-api CMake package and only falls back to this file).
 *
 ...
 *
 * Do not edit this file. To update it, copy the upstream file over it verbatim
 * and change the commit hash above, so that drift from upstream stays visible.
 */
